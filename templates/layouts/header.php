...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title><?php echo getSetting('site_title', 'Kverify Digital Solutions - Professional Web Developer Portfolio'); ?></title>
    <meta name="title" content="<?php echo getSetting('site_title', 'Kverify Digital Solutions - Professional Web Developer Portfolio'); ?>">
    <meta name="description" content="<?php echo getSetting('site_description', 'Professional web developer specializing in custom PHP solutions, responsive designs, and web applications.'); ?>">
    ...
    <meta property="og:title" content="<?php echo getSetting('site_title', 'Kverify Digital Solutions'); ?>">
    <meta property="og:description" content="<?php echo getSetting('site_description', 'Professional web developer portfolio'); ?>">
    ...
    <meta property="twitter:title" content="<?php echo getSetting('site_title', 'Kverify Digital Solutions'); ?>">
    <meta property="twitter:description" content="<?php echo getSetting('site_description', 'Professional web developer portfolio'); ?>">
                ...
                <ul class="nav-menu" id="navMenu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="#maintenance" class="dropdown-item">Maintenance</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo BASE_URL; ?>/tutorials" class="dropdown-item">Tutorials</a></li>
                            <li><a href="<?php echo BASE_URL; ?>/guides" class="dropdown-item">Guides</a></li>
                            <li><a href="<?php echo BASE_URL; ?>/faq" class="dropdown-item">FAQ</a></li>
